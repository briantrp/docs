...
<Note>
  AI features (Brain, chat, AI automation) use the AI provider you configure after installation under **Settings → AI** — for example OpenAI, Anthropic, or your own Ollama server. They do not need extra server RAM.
</Note>
...
AI features need an AI provider to be configured. Go to **Settings → AI**, choose a provider (for example OpenAI or your own Ollama server), enter its access key, and use the **Test connection** button. If the test succeeds and Brain still does not work, contact Collabase support.
